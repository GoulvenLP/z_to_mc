...
class AliceBobReminder(RootedRelation):

    def __init__(self, alice, bob):
        """
            initialisation. States can be 'i', 'c', 'r'
    ...
    def actions(self, config):
        ...
        if (current_bob == 'i'):
            ...
            next_bob = 'r'
        elif (current_bob == 'r' and current_alice == 'i'):
            next_bob = 'c'
        elif (current_bob == 'c'):
            next_bob = 'i'
...
def main():
    ...
    alice_bob_rr = AliceBobReminder(alice='i', bob='i')
